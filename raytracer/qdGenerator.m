...
% Modified by: Yunqi Feng <Yunqi.Feng@UGent.be> for diffuse component
% generation
...
switch qdModelSwitch
    ...
    case 'DBARC'
        outputPre = getDBARCQdOutput(delayLos, cursorOutput, arrayOfMaterials,...
            materialLibrary, diffusePathGainThreshold, 'pre');
        outputPost = getDBARCQdOutput(delayLos, cursorOutput, arrayOfMaterials,...
            materialLibrary, diffusePathGainThreshold, 'post');
...
function output = getDBARCQdOutput(delayLos, dRayOutput, arrayOfMaterials, ...
    materialLibrary, diffusePathGainThreshold, prePostParam)
params = getParams(arrayOfMaterials, materialLibrary, prePostParam);
