...
% DIFFRACTIONREFLECTIONPATHGENERATOR Finds paths that undergo one
% diffraction then one reflection.
% ... (rest of the help text)
    ...
    for i = 1:size(CADop, 1)
        ...
        Rx_image = reflectedImagePointPlane(Rx, reflecting_plane_eq);
        vrx_image = reflectedVelocity(vrx, reflecting_plane_eq);
        ...
        [diffraction_output_from_image, multipath_tmp, tmp_plane, plane_mat,diffraction_loss_dB] = ...
            diffractionPathGenerator_image(Tx, Rx_image, wedges, CADop, ...
            vtx, vrx_image, frequency, LOS_output,pseudo_LOS_output,polarization, Jones,Ptx, antenna, ...
        ...
        if ~isempty(diffraction_output_from_image)
            for j = 1:size(diffraction_output_from_image, 1)
                ...
                dir_vector = -(Rx_image - diffraction_point);
                ...
                is_path_to_reflection_clear = verifyPath(Rx, reflection_point, ...
                    reflection_point - Rx, [0,0,0,0], [0,0,0,0], CADop, 2, false);
                ...
                d_tx_refl = norm(reflection_point - Rx);
                d_refl_diff = norm(diffraction_point - reflection_point);
                d_diff_rx = norm(Tx - diffraction_point);
                ...
                multipathtmp = [1,Rx,reflection_point,diffraction_point];
                ...
                dod = Tx - diffraction_point;
                doa = reflection_point - Rx;
