function  [x_cen,y_cen,z_cen]=generate_scatterergrid_2d(confg_dim,scatterer_num,scatterer_dim,IndoorSwitch,x_dep, ...
    y_dep,z_dep,x_cen,y_cen,z_cen,NodeLocTx,NodeLocRx,scatterer_height_max,int_safety,confg_safety)
...
z2=NodeLocRx(3);
%if z1~=z2
    %error('AP and UE heights are different, but the scatterers should be displyed in a 2D disk')
%end
if IndoorSwitch==1
    ...
    %scatterer_z=min(z2,height_max);  
    scatterer_z=height_max;  
    newAllPoints = [];
