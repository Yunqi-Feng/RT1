...
scenarioName = extractAfter(mainPath, '/output/');
app.scenarioName = scenarioName;

if strcmp(app.UIAxes.Title.Interpreter, 'tex')
    app.UIAxes.Title.String = strrep(scenarioName, '_', '\_');
else
    app.UIAxes.Title.String = scenarioName;
end

app.visualizerPath = fullfile(mainPath,'Visualizer');
app.ns3Path = fullfile(mainPath,'Ns3');
